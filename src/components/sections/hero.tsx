  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo(
        ".hero-enter",
        { y: 60, opacity: 0 },
        { y: 0, opacity: 1, stagger: 0.12, duration: 0.9, ease: "power3.out", delay: 1.8 }
      );
      gsap.fromTo(
        ".hero-photo",
        { scale: 0.8, opacity: 0 },
        { scale: 1, opacity: 1, duration: 1.1, ease: "power3.out", delay: 2.1 }
      );
    }, sectionRef);
    return () => ctx.revert();
  }, []);
          ...
          <div className="flex flex-col gap-6">
            <div className="hero-enter flex items-center gap-3 opacity-0">
              <div className="open-to-work-badge px-3 py-1 rounded-full">
                <span className="font-mono text-[11px] text-emerald-200 font-medium tracking-wide">
            ...
            <div className="hero-enter opacity-0">
              <h1 className="font-display font-bold leading-[0.95] tracking-tight">
                <span className="block text-[clamp(3rem,7vw,5.5rem)] text-foreground">
                  Dipesh
                </span>
                <span className="block text-[clamp(3rem,7vw,5.5rem)] text-gradient mt-1">
                  Sharma
                </span>
              </h1>
            </div>
            ...
            <p className="hero-enter opacity-0 text-muted-foreground leading-[1.8] max-w-[540px] text-[0.95rem]">
              Computer Engineering Undergrad (B.E. 2026, CGPA 8.00) with 3 internships
              in full-stack development and data science. I build production MERN apps,
              ML-powered recommendation systems, and real-time computer vision platforms.
              Currently an SDE Intern at ITJOBXS. Actively seeking full-time SDE roles.
            </p>
            ...
            <div className="relative">
              <div className="w-[340px] h-[420px] rounded-3xl overflow-hidden border border-border/40 glow-primary">
                <Image
                  ...
                  alt="Dipesh Sharma - Full Stack Developer"
                  fill
              ...
              <div className="float-anim absolute -top-4 -right-4 glass rounded-xl px-3 py-1.5 font-mono text-[11px] text-primary border border-primary/20">
                {"<React />"}
              </div>
              <div className="float-anim-r absolute -bottom-4 -left-4 glass rounded-xl px-3 py-1.5 font-mono text-[11px] text-teal-400 border border-teal-500/20">
                {"{ AI/ML }"}
              </div>
            </div>
          </div>
