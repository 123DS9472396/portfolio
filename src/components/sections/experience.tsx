...
export function ExperienceSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo(".exp-header", { y: 40, opacity: 0 }, {
        y: 0, opacity: 1, duration: 0.8, ease: "power3.out",
        scrollTrigger: { trigger: ".exp-header", start: "top 82%", once: true },
      });
      gsap.fromTo(".timeline-line", { height: "0%" }, {
      ...
      document.querySelectorAll(".timeline-dot").forEach((dot, i) => {
        gsap.fromTo(dot, { scale: 0.4, opacity: 0 }, {
          scale: 1, opacity: 1, duration: 0.4, delay: i * 0.15 + 0.3,
      ...
      <div className="section-container relative z-10">
        <div className="exp-header text-center mb-16">
          <div className="section-label justify-center mb-3">
            <span className="font-mono text-xs text-primary tracking-[0.2em] uppercase">Internships</span>
          </div>
          ...
          <p className="mt-4 text-muted-foreground text-sm max-w-lg mx-auto leading-relaxed">
            3 internships across full-stack development, ML engineering, and data science.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="timeline-wrap relative pl-8 border-l border-border/30">
            ...
            {experienceConfig.map((item, i) => {
              ...
              const TypeIcon = typeInfo?.icon || HiGlobe;
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                      ...
                      <div className="flex flex-col items-end gap-1.5">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-mono text-[10px]" style={{ color: typeColor }}>
                            {typeLabel}
                          </span>
                          {item.location && (
                            <>
