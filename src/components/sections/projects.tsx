        ...
        <ResponsiveDialogTrigger className="bg-transparent flex justify-center">
          ...
          >
            {project.src ? (
              ...
              <div className="absolute w-full h-full top-0 left-0 bg-gradient-to-br from-primary/30 to-primary/5 flex items-center justify-center hover:scale-[1.05] transition-all">
                <span className="text-5xl font-bold text-primary/40 font-display">
